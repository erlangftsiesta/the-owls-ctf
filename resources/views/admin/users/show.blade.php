...
<head>
    ...
    <title>Detil Pengguna {{ $user->name }} - Tutorial CRUD Laravel 12 @ qadrlabs.com</title>
...
<div class="container mx-auto mt-10 mb-10 px-10">
    <div class="grid grid-cols-8 gap-4 mb-4 p-5">
        <div class="col-span-4 mt-2">
            <h1 class="text-3xl font-bold text-white">
                Detil Pengguna {{ $user->name }}
            </h1>

        </div>
    </div>
    <div class="bg-gray-700 p-5 rounded shadow-sm">
    ...
    <a href="{{ route('user.edit', $user) }}"
       ...
       id="edit-user-btn">Edit Pengguna</a>
